        ...
        pipes=[
            pipelines.base.Pipe(
                ...
                steps=[
                    ...
                    transformers.EuropePMCSourceCreateXMLCollectionDocument(
                        query="",
                        articles=-1,
                        hours=-1,
                        from_date="",
...
def ingest(query, articles, hours, from_date, to_date, cursor):
    ...
    manifest = manifests.base.Manifest(
        sources=[
            manifests.sources.EuropePMC(
                id="id",
                pipeline="pipeline_europepmc_xml",
                query=query,
                articles=articles,
                hours=hours,
                from_date=from_date,
...
def main():
    ...
    ingest_parser.add_argument("--cursor", type=str, default="")
